...
public class ScheduleSolver {
    ...
    public ValidationResult validateAssignment(
        ...
        if (violatesBackToBackRule(employee.getId(), shift, employeeShiftHistory, shiftMap)) {
            return new ValidationResult(false, "back_to_back", "Employee cannot work closing then opening shift");
        }
