...
public class ScheduleService {
    ...
    public ValidationResult validateAssignment(HttpServletRequest request, Long employeeId, Long shiftId) throws Exception {
        ...
        return scheduleSolver.validateAssignment(employee, shift, shifts, unavailability, assignments);
    }
    ...
    // NOTE: only rows with status "confirmed" are included, so cancelled/rejected
    // assignment rows in the Data Store no longer count against an employee's hours.
